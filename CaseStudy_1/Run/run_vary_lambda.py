...
#working_directory = '/root/Thermodynamic_Integration/CaseStudy_1/Run/'
# the path of file 'run' 
run_path = "/home/user/Documents/GitHub/Thermodynamic_Integration/CaseStudy_1/Run/run"
#run_path = "/root/Thermodynamic_Integration/CaseStudy_1/Run/run"
...
#data_path = '/root/Thermodynamic_Integration/'
